        ...
        <div className="mx-auto max-w-2xl py-36 sm:py-40">
          ...
          <div className="text-center">
            ...
            <div className="mt-10 flex items-center justify-center gap-x-6">
              <Link
                className="text-md flex h-12 w-32 items-center justify-center space-x-2 rounded-full border border-neutral-800 bg-gray-100 bg-neutral-800/50 font-sf-pro-rounded-regular text-neutral-100 shadow-xl transition-all hover:border-neutral-500/10 hover:text-neutral-100/75 hover:shadow-neutral-700/10"
              ...
              <Link
                className="group relative flex h-12 w-36 items-center justify-center overflow-hidden rounded-full border border-neutral-800/50 bg-transparent text-center font-sf-pro-rounded-regular text-sm text-neutral-100 transition hover:border-neutral-800/85 hover:text-neutral-100/85"
                href="https://github.com/opxica/modular-ui-website"
                target="_blank"
                rel="noopener noreferrer"
              >
                <span className="absolute -end-full transition-all group-hover:end-4">
                  <IconStarFilled size={14} className="text-yellow-200" />
                </span>
